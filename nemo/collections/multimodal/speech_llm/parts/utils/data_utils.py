...
class TextProcessing:
    ...
    def __init__(
        ...
        # elif hasattr(tokenizer.tokenizer, "_added_tokens_encoder") and '<|im_end|>' in tokenizer.tokenizer._added_tokens_encoder: # not needed
        #     self.eos_id = tokenizer.tokenizer._added_tokens_encoder['<|im_end|>']
        #     tokenizer.eos_id = self.eos_id
        else:
            self.eos_id = None
